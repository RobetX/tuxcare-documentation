import{_ as e,n as i,p as n,a7 as d}from"./framework-0ba8e1ea.js";const s={},a=d(`<h1 id="eportal-api" tabindex="-1"><a class="header-anchor" href="#eportal-api" aria-hidden="true">#</a> ePortal API</h1><p>以下のコマンドで、API使用のための別のePortalアカウントを作成する必要がある場合があります。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>kc.eportal user -a api-user -p &lt;password&gt;
